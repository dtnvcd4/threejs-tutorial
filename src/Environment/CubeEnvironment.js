...
import Salsa from '../Assets/Models/class_car.glb'
...
class CubeEnvironment extends Component {
    ...
    constructor(props) {
		...
		this.overlayItem = new OverlayItem(
			...
			"VIDEO", 
			"https://www.youtube.com/embed/G8gCKCAXgBc"
		)
      }
	...
	populateScene = () => {
		...
		//this.addCube( new THREE.Vector3(0,0,0),this.overlayItem);
		 this.addModel(Salsa, new THREE.Vector3(0,0,0), this.overlayItem);
		 this.setupFog();
	};
	 ...
	 */
	setupFog = () => {
		this.scene.fog = new THREE.FogExp2(new THREE.Color('white'), 0.3); // Color, Density
	};
